              ...
              <div className="mx-auto w-full max-w-[400px] lg:max-w-none lg:order-last animate-fade-in">
                <div className="relative">
                  ...
                  <div className="absolute inset-4 animate-spin-reverse">
                    <div className="w-full h-full border-2 border-cyan-400/40 rounded-full border-dashed"></div>
                  </div>
                  <div className="absolute inset-8 animate-pulse">
                    <div className="w-full h-full border border-pink-400/50 rounded-full"></div>
                  </div>
                  ...
                  <div className="absolute inset-0">
                    ...
                    <div
                      className="absolute top-3/4 right-1/4 w-1.5 h-1.5 bg-cyan-400 rounded-full animate-bounce"
                      style={{ animationDelay: "0.5s" }}
                    ></div>
                    <div
                      className="absolute bottom-1/4 left-3/4 w-1 h-1 bg-purple-400 rounded-full animate-pulse"
                      style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                      className="absolute top-1/2 right-1/2 w-1.5 h-1.5 bg-pink-400 rounded-full animate-ping"
                      style={{ animationDelay: "1.5s" }}
                    ></div>
                  </div>

                  {/* Efeito de holograma */}
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-400/20 via-transparent to-cyan-400/20 rounded-xl blur-xl opacity-60 animate-pulse"></div>
                  ...
                  <div className="absolute inset-0 overflow-hidden rounded-xl">
                    ...
                    <div
                      className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-scan-line-reverse"
                      style={{ animationDelay: "2s" }}
                    ></div>
                  </div>

                  {/* Container da imagem com efeito glitch */}
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 rounded-xl blur-2xl group-hover:blur-3xl transition-all duration-500"></div>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-white/20 backdrop-blur-sm bg-white/5">
                      <Image
                        ...
                        className="relative w-full h-auto object-cover transform group-hover:scale-105 transition-all duration-700 filter group-hover:brightness-110"
                      />

                      {/* Overlay tecnológico */}
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-purple-500/20 opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
               ...
               `,
                    ...
                    {/* Botão de play holográfico */}
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="relative">
                        <div className="absolute inset-0 bg-white/20 rounded-full blur-xl animate-pulse"></div>
                        <button className="relative w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center shadow-2xl transform hover:scale-110 transition-all duration-300">
              ...
              <div className="mt-16 animate-fade-in">
                ...
                <div className="grid grid-cols-3 md:grid-cols-6 gap-6">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-110"
                    >
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 ${tech.color === "bg-black" ? "bg-white" : tech.color}`}
                      >
                        <Image
